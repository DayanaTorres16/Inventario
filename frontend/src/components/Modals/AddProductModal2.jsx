...
const AddProductModalTienda2 = ({ isOpen, onClose, onAdd }) => {
    ...
    const idTienda = 2; // Cambiado a 2 para la tienda 2
    ...
    return (
        <div className="modal">
            <div className="modal-content">
                <h3>Agregar Producto</h3> {/* Cambiado el título */}
...
export default AddProductModalTienda2;